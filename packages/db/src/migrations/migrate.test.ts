...
describe("runMigrations", () => {
  it("creates all vertical-slice tables from 0001_initial.sql through 0005_worlds.sql", () => {
    const db = openDatabase(":memory:");
    const applied = runMigrations(db);

    expect(applied).toEqual(["0001_initial", "0002_audio_assets", "0003_learner_errors", "0004_imported_content", "0005_worlds"]);
